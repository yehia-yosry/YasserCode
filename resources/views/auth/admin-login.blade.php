...
{{-- Navbar (uses only existing routes: none needed here) --}}
            ...
            <div class="card card-soft">
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <h2 class="h4 fw-bold mt-3 mb-1">Admin Login</h2>
                        <div class="muted">Sign in to manage the bookstore</div>
                    </div>

                    {{-- Error message (same session key + same logic) --}}
                    @if(@session('error'))
                    ...
                    <form method="POST" action="{{ route('admin.login.submit') }}">
                        ...
                        <div class="d-flex flex-column gap-2 mt-3">
                            <p class="text-center mb-0 muted">
                                Don't have an account?
                                <a class="text-decoration-none fw-semibold" href="{{ route('admin.register') }}">
                                    Register here
                                </a>
                            </p>
                            ...
                            <p class="text-center mb-0 muted">
                                Customer?
                                <a class="text-decoration-none fw-semibold" href="{{ route('customer.login') }}">
                                    Customer Login
                                </a>
                            </p>
                        </div>
