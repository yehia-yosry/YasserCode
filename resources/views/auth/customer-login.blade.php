            ...
            <div class="card card-soft">
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <h2 class="h4 fw-bold mt-3 mb-1">Customer Login</h2>
                        <div class="muted">Sign in to continue shopping</div>
                    </div>
                    ...
                    <form method="POST" action="{{ route('customer.login.submit') }}">
                        ...
                        <div class="d-flex flex-column gap-2 mt-3">
                            <p class="text-center mb-0 muted">
                                ...
                                <a class="text-decoration-none fw-semibold" href="{{ route('customer.register') }}">
                                    Register here
                                </a>
                            </p>
                            <p class="text-center mb-0 muted">
