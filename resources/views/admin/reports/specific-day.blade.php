...
<nav class="navbar bg-white border-bottom sticky-top">
    <div class="container py-2 d-flex align-items-center justify-content-between">
        ...
        <span class="badge rounded-pill text-bg-light border py-2 px-3">
            <i class="bi bi-bar-chart-line me-1"></i> Sales Result
        </span>
    </div>
</nav>
...
<main class="container py-4 py-lg-5">
    ...
    <div class="d-flex flex-column flex-md-row align-items-md-end justify-content-between gap-2 mb-4">
        <div>
            <h1 class="h3 fw-bold mb-1">Total Sales for {{ $date }}</h1>
            <div class="muted">Daily sales summary for the selected date.</div>
        </div>

        <div class="d-flex flex-wrap gap-2">
            <a href="{{ route('admin.reports.specific.day.form') }}" class="btn btn-outline-secondary">
                <i class="bi bi-arrow-repeat me-1"></i> Check Another Date
            </a>
            ...
            <div class="card card-soft h-100">
                <div class="card-body p-4 p-lg-5">
                    <div class="d-flex align-items-start gap-3">
                        ...
                        <div>
                            <div class="fw-bold mb-1">Selected Date</div>
                            <div class="pill d-inline-flex align-items-center gap-2 px-3 py-2 mt-2">
                                <i class="bi bi-dot"></i>
                                <span class="fw-semibold">{{ $date }}</span>
                            </div>
                            <div class="small muted mt-3">Sales values shown are totals for this day only.</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="metric card-soft p-4 p-lg-5 h-100">
                <div class="d-flex align-items-start justify-content-between">
                    <div>
                        ...
                        <div class="small muted">All recorded sales for {{ $date }}.</div>
                    </div>
