...
<nav class="navbar bg-white border-bottom sticky-top">
    <div class="container py-2 d-flex align-items-center justify-content-between">
        ...
        <span class="badge rounded-pill text-bg-light border py-2 px-3">
            <i class="bi bi-trophy me-1"></i> Top Books
        </span>
    </div>
</nav>
...
<main class="container py-4 py-lg-5">
    ...
    <div class="d-flex flex-column flex-md-row align-items-md-end justify-content-between gap-2 mb-4">
        <div>
            <h1 class="h3 fw-bold mb-1">Top 10 Selling Books (Last 3 Months)</h1>
            <div class="muted">Best-selling titles based on total copies sold.</div>
        </div>
    ...
    <div class="card card-soft mb-4">
        <div class="card-body p-4 d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-2">
            ...
            <span class="badge text-bg-light border py-2 px-3">
                <i class="bi bi-graph-up-arrow me-1"></i> Last 3 months
            </span>
        </div>
    </div>
    ...
    @if(count($books) > 0)
        <div class="card card-soft">
            <div class="card-header bg-white border-0 pt-4 px-4">
                ...
                <div class="muted small mt-1">Top 10 books by total sold copies.</div>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table align-middle mb-0">
                        ...
                        <tr>
                            ...
                            <th>Title</th>
                            <th class="text-nowrap text-end">Total Copies Sold</th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach($books as $index => $book)
                            <tr class="{{ $index < 3 ? 'top-row' : '' }}">
                                ...
                                <td class="fw-semibold">
                                    {{ $book->Title }}
                                    @if($index == 0)
                                        <span class="badge text-bg-warning ms-2"><i class="bi bi-star-fill me-1"></i>#1</span>
                                    @endif
                                </td>
    ...
    @else
        <div class="card card-soft">
            <div class="card-body p-5 text-center">
                ...
                <h2 class="h5 fw-bold mb-2">No sales found</h2>
                <p class="muted mb-4">No book sales found in the last 3 months.</p>
